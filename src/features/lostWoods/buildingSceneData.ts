...
export const createBuildingSceneData = (): BuildingSceneData => {
  ...
  placeDecor(map, decor, 17, 31, 'screen', true)
  placeDecor(map, decor, 25, 31, 'screen', true)
  placeDecor(map, decor, 18, 30, 'chair', true)
  placeDecor(map, decor, 24, 30, 'chair', true)

  placeDecor(map, decor, 10, 29, 'shelf', true)
  placeDecor(map, decor, 12, 31, 'desk', true)
  placeDecor(map, decor, 11, 32, 'chair', true)
  placeDecor(map, decor, 13, 29, 'table', true)
  placeDecor(map, decor, 10, 31, 'portrait', true)

  placeDecor(map, decor, 31, 29, 'shelf', true)
  placeDecor(map, decor, 32, 31, 'chest', true)
  placeDecor(map, decor, 30, 30, 'table', true)
  placeDecor(map, decor, 31, 32, 'statue', true)
  placeDecor(map, decor, 29, 31, 'clock', true)
